    ...
    viewer.camera.flyTo({
      ...
      complete: () => {
        ...
        viewer.entities.add({
          ...
          billboard: {
            scale: 0.8,
            image: "http://localhost:8888/data/icones/adressage.svg",
          ...
          label: {
            ...
            fillColor: Cesium.Color.fromCssColorString("#F0F0E9"),
            outlineColor: Cesium.Color.fromCssColorString("#423734"),
            outlineWidth: 8,
