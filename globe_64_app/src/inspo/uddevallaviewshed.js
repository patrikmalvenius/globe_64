...
!(function (first_parameter, second_parameter) {
  var first_variable = {
  ...
  first_variable["ViGJZ"](first_variable["eJGiW"], typeof exports) &&
  first_variable["ViGJZ"](first_variable["eJGiW"], typeof module)
    ? (module["exports"] = first_variable["JOuXj"](
        second_parameter,
        first_variable["rfkXD"](require, first_variable["JOQHD"])
      ))
    : first_variable["ViGJZ"](first_variable["sVMtp"], typeof define) &&
      define["amd"]
    ? first_variable["Ounbr"](
        define,
        [first_variable["JOQHD"]],
        second_parameter
      )
    : first_variable["ViGJZ"](first_variable["eJGiW"], typeof exports)
    ? (exports["space"] = first_variable["rfkXD"](
        second_parameter,
        first_variable["XoUNH"](require, first_variable["JOQHD"])
      ))
    : (first_parameter["space"] = first_variable["XoUNH"](
        second_parameter,
        first_parameter["Cesium"]
      ));
